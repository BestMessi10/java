			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form role="form" id="newsForm" action="${APP_PATH}/managernews/insert"
							medthod="post">
							...
							<div class="row">
								...
								<div class="col-lg-3">
									...
									<input type="text" name="publishTime" id="publishTime" class="form-control ui_timepicker" value="">
										</div>
								</div>
		...
		$(function() {
			...
			$("#insertBtn")
					.click(
							function() {
								//getContent();
								var columnId = $("#columnId option:selected")
										.val();
								if (ue.getContent() == null
									...
									$("#contentText").val(ue.getContentTxt());
								}
								...
								$
										.ajax({
											type : "POST",
											url : "${APP_PATH}/managernews/insert",
											data : {
												"user" : $("#user").val(),
												"title" : title,
												"columnId" : columnId,
											...
											success : function(result) {
												...
												if (result.success) {
													layer.msg(
																...
																function() {
																	window.location.href = "${APP_PATH}/managernews/index";
																});
												} else {
