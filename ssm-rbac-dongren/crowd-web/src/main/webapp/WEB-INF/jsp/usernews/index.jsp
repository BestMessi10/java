...
<button type="button" class="btn btn-primary" style="float:right;" onclick="window.location.href='${APP_PATH}/usernews/add'"><i class="glyphicon glyphicon-plus"></i> 新增</button>
<br>
 <hr style="clear:both;">
	...
	<script src="${APP_PATH}/layer/layer.js"></script>
        <script type="text/javascript">
            ...
            function pageQuery( pageno ) {
            	...
            	$.ajax({
            		type : "POST",
            		url  : "${APP_PATH}/usernews/pageQuery",
            		data : jsonData,
            		beforeSend : function(){
            ...
            function goUpdatePage(id) {
            	window.location.href = "${APP_PATH}/usernews/edit?id="+id;
            }
