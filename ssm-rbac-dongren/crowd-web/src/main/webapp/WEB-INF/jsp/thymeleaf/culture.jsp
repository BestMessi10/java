...
<html>
	...
	<body class="drwh" style='background: url(../img1/bg_con.jpg) no-repeat;background-size: cover;'>
		<header>
			<div class="layout">
				...
				<ul class="nav">
					...
					<c:forEach items="${dongColumns }" var="dongColumn">
						<c:if test="${dongColumn.url == 'culture' }">
			...
			<div class="swiper-container swiper-container1">
			    <div class="swiper-wrapper">
				    <div class="swiper-slide">
				    	<a href="">
				    		<img src="${APP_PATH}/img1/c_img1.jpg"/>
				    	</a>
				    </div>
				    <div class="swiper-slide">
				    	<a href="">
		  	...
		  	<%-- <a href="flash_detail.html" class="drwh_item">
		  		<p href="" class="size20 bold color333">显现出独具审美认知的城市意象，绿色生活</p>
		  		<div class="drwh_item_pic over_hidden">
		  			<figure class="imghvr-shutter-out-horiz img-responsive">
		  				<img src="${APP_PATH}/img1/c_img10.jpg" alt="example-image">
			            <div></div>
			        </figure>
		  			<figure class="imghvr-shutter-out-horiz img-responsive">
		  				<img src="${APP_PATH}/img1/c_img11.jpg" alt="example-image">
			            <div></div>
			        </figure>
		  			<figure class="imghvr-shutter-out-horiz img-responsive">
		  				<img src="${APP_PATH}/img1/c_img12.jpg" alt="example-image">
			            <div></div>
			        </figure>
		  			<figure class="imghvr-shutter-out-horiz img-responsive">
		  				<img src="${APP_PATH}/img1/c_img13.jpg" alt="example-image">
			            <div></div>
			        </figure>
		  		</div>
	  			<p  class="color666">
		...
		var likeflg = false;
		  $(function(){
		    ...
		    function pageQuery( pageno ) {
            	...
            	var jsonData = {"pageno" : pageno, "pagesize" : 8, "column" : 2};
            	if ( likeflg == true ) {
            	...
            	$.ajax({
            		...
            		success : function(result) {
            			...
            			if ( result.success ) {
            				...
            				var dongNewss = dongNewsPage.datas;
            				console.log(dongNewss);
            				
            				/*  $.each(dongNews,function(i,dongNew){
            					$.each(dongNew.imgs,function(i, singleimg){
            						console.log(singleimg);
            					})
            					
            				}); */ 
            				 //return;
            				$.each(dongNewss, function(i, dongNews){
            					//必须每次拼接以后要置为0！
            					var imgContent = "";
            					$.each(dongNews.imgs,function(i, singleimg){
		            			
            						imgContent +='<figure class="imghvr-shutter-out-horiz img-responsive">';
            						imgContent +='<img src="'+singleimg+'" alt="example-image">';
            						imgContent +='<div></div>';  
            						imgContent +='</figure>';
        					}) ;
            					
			            		tableContent +='<a href=flash_detail?newsid='+dongNews.id+' class="drwh_item">';
			            		tableContent +='<p href="" class="size20 bold color333">'+dongNews.title+'</p>';
			            		tableContent +='<div class="drwh_item_pic over_hidden">';
			            		tableContent += imgContent;
			            		tableContent +='</div>';
			            		tableContent +='<p  class="color666">';
			            		tableContent +='<span class="bold">'+dongNews.user+'</span>';
			            		tableContent +=dongNews.publishTime
			            		tableContent +='</p>';
			            		tableContent +='<span class="line"></span>';
			            		tableContent +='</a>';
